...
class SALLoginPageState extends State<SALLoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      key: _key,
      body: Form(key: _formKey, child: _body()),
    );
  }
              ...
              children: <Widget>[
                ...
                Container(
                  margin: EdgeInsets.symmetric(
                      vertical: 20,
                      horizontal: ScreenUtil.getInstance().setHeight(18)),
                  child: Column(children: <Widget>[
                    ...
                    SizedBox(height: 8),
                    SALPasswordField(
                        passwordEditController: passwordController),
                    SizedBox(height: 10),
  ...
  Widget _buildLoginSection() => Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text("Login with", style: kSmallTextStyle),
            SizedBox(height: 10),
            Row(
